...
export function Footer({ theme }: { theme: "dark" | "light" }) {
  ...
  return (
    <footer className={`w-full py-8 px-6 lg:px-20 border-t-2 relative z-[1000] ${isDark ? "bg-[#0A0C16] border-indigo-500/20" : "bg-white border-slate-100"
      }`}>
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className={`text-xs font-bold ${isDark ? "text-white/50" : "text-slate-600"}`}>
                Akshara Enterprises, MG Road, BHIVE, Bangalore, KA 560001
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <a href="mailto:admin@aksharaenterprises.info" className="flex items-center gap-4 group">
              ...
              <span className={`text-xs font-bold ${isDark ? "text-white/50 group-hover:text-white" : "text-slate-600"} transition-colors`}>
                admin@aksharaenterprises.info
              </span>
            </a>
            <a href="tel:+919353674689" className="flex items-center gap-4 group">
              <div className={`p-2.5 rounded-xl ${isDark ? "bg-indigo-500/10 group-hover:bg-indigo-500/30" : "bg-slate-50"} transition-all`}>
          ...
          <div className="flex items-center gap-4">
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-all relative ${copied
